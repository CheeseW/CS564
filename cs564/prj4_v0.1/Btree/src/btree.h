...
class BTreeIndex {
 ...
 private:
   ...
   */
  PageKeyPair<int> leafNodeInsertSplit(LeafNodeInt* curNode, int key, RecordId rid);
   ...
   */
  void nonLeafNodeInsert(NonLeafNodeInt* node, PageKeyPair<int> updateTuple);
   ...
   */
  PageKeyPair<int> nonLeafNodeInsertSplit(NonLeafNodeInt* curNode, PageKeyPair<int> updateTuple);
   ...
   */
  recurStruct insertEntryUpdate(int key, RecordId rid, PageId pid, bool isRoot);
